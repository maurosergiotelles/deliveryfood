package com.deliveryfood.client.exception;

import org.springframework.web.client.RestClientResponseException;

import com.deliveryfood.client.model.Problem;
...
public class ClientApiException extends RuntimeException {
	...
	private void deserializeProblem(RestClientResponseException cause) {
		...
		try {
			...
			log.warn("Não foi possível desserializar a resposta devido a  um problema", e);
		}
